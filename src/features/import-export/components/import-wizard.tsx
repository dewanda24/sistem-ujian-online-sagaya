...
const masterModules: Array<{ value: TemplateType; label: string }> = [
  ...
  { value: "student-class-assignments", label: "Assignment Siswa-Kelas" },
  {
    value: "teacher-subject-assignments",
    label: "Assignment Guru-Mapel-Kelas",
  },
];
          ...
          <div className="grid gap-3">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                Ikuti urutan wizard: pilih modul, unduh template, upload,
                validasi, preview, commit, lalu ambil result.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <span className="rounded-full bg-slate-100 px-3 py-2 text-xs font-medium text-slate-700">
                Commit hanya aktif setelah validasi valid
              </span>
              {selectedModule === "questions-excel" ||
