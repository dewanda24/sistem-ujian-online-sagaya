...
export const importTemplates: Record<TemplateType, TemplateDefinition> = {
  ...
  questions: {
    ...
    columns: [
      ...
      { key: "category", example: "Aljabar" },
      { key: "difficulty", example: "medium" },
      { key: "question_type", example: "multiple_choice" },
      { key: "question_text", example: "Hasil dari $2x+5=17$ adalah ..." },
      { key: "option_a", example: "$4$" },
      { key: "option_b", example: "$5$" },
      { key: "option_c", example: "$6$" },
      { key: "option_d", example: "$7$" },
      { key: "option_e", example: "$8$" },
      { key: "correct_answer", example: "B" },
      { key: "explanation", example: "$2x=12$, jadi $x=6$" },
